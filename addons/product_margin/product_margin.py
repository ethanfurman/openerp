...
class product_product(osv.osv):
    ...
    _columns = {
        ...
        'sale_avg_price' : fields.function(_product_margin, type='float', digits=(16,2), string='Avg. Unit Price', multi='product_margin',
            help="Avg. Price in Customer Invoices."),
        'purchase_avg_price' : fields.function(_product_margin, type='float', digits=(16,2), string='Avg. Unit Price', multi='product_margin',
            help="Avg. Price in Supplier Invoices "),
        'sale_num_invoiced' : fields.function(_product_margin, type='float', digits=(16,2), string='# Invoiced in Sale', multi='product_margin',
            help="Sum of Quantity in Customer Invoices"),
        'purchase_num_invoiced' : fields.function(_product_margin, type='float', digits=(16,2), string='# Invoiced in Purchase', multi='product_margin',
            help="Sum of Quantity in Supplier Invoices"),
        'sales_gap' : fields.function(_product_margin, type='float', digits=(16,2), string='Sales Gap', multi='product_margin',
            help="Expected Sale - Turn Over"),
        'purchase_gap' : fields.function(_product_margin, type='float', digits=(16,2), string='Purchase Gap', multi='product_margin',
            help="Normal Cost - Total Cost"),
        'turnover' : fields.function(_product_margin, type='float', digits=(16,2), string='Turnover' ,multi='product_margin',
            help="Sum of Multiplication of Invoice price and quantity of Customer Invoices"),
        'total_cost'  : fields.function(_product_margin, type='float', digits=(16,2), string='Total Cost', multi='product_margin',
            help="Sum of Multiplication of Invoice price and quantity of Supplier Invoices "),
        'sale_expected' :  fields.function(_product_margin, type='float', digits=(16,2), string='Expected Sale', multi='product_margin',
            help="Sum of Multiplication of Sale Catalog price and quantity of Customer Invoices"),
        'normal_cost'  : fields.function(_product_margin, type='float', digits=(16,2), string='Normal Cost', multi='product_margin',
            help="Sum of Multiplication of Cost price and quantity of Supplier Invoices"),
        'total_margin' : fields.function(_product_margin, type='float', digits=(16,2), string='Total Margin', multi='product_margin',
            help="Turnover - Standard price"),
        'expected_margin' : fields.function(_product_margin, type='float', digits=(16,2), string='Expected Margin', multi='product_margin',
            help="Expected Sale - Normal Cost"),
        'total_margin_rate' : fields.function(_product_margin, type='float', digits=(16,2), string='Total Margin Rate(%)', multi='product_margin',
            help="Total margin * 100 / Turnover"),
        'expected_margin_rate' : fields.function(_product_margin, type='float', digits=(16,2), string='Expected Margin (%)', multi='product_margin',

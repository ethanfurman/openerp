...
class account_treasury_report(osv.osv):
    ...
    _columns = {
        ...
        'starting_balance': fields.function(_compute_balances, digits_compute=dp.get_precision('Account'), string='Starting Balance', type='float', multi='balance'),
        'ending_balance': fields.function(_compute_balances, digits_compute=dp.get_precision('Account'), string='Ending Balance', type='float', multi='balance'),

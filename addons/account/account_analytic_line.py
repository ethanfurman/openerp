...
class account_analytic_line(osv.osv):
    ...
    _columns = {
        ...
        'amount_currency': fields.related('move_id', 'amount_currency', type='float', digits=(16,2), string='Amount Currency', store=True, help="The amount expressed in the related account currency if not equal to the company one.", readonly=True),
    }

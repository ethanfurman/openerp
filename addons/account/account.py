...
#                if can_compute:
    ...
    _columns = {
        ...
        'balance': fields.function(__compute, digits_compute=dp.get_precision('Account'), string='Balance', type='float', multi='balance'),
        'credit': fields.function(__compute, fnct_inv=_set_credit_debit, digits_compute=dp.get_precision('Account'), string='Credit', type='float', multi='balance'),
        'debit': fields.function(__compute, fnct_inv=_set_credit_debit, digits_compute=dp.get_precision('Account'), string='Debit', type='float', multi='balance'),
        'foreign_balance': fields.function(__compute, digits_compute=dp.get_precision('Account'), string='Foreign Balance', type='float', multi='balance',
                                           help="Total amount (in Secondary currency) for transactions held in secondary currency for this account."),
        'adjusted_balance': fields.function(__compute, digits_compute=dp.get_precision('Account'), string='Adjusted Balance', type='float', multi='balance',
                                            help="Total amount (in Company currency) for transactions held in secondary currency for this account."),
        'unrealized_gain_loss': fields.function(__compute, digits_compute=dp.get_precision('Account'), string='Unrealized Gain or Loss', type='float', multi='balance',
        ...
        'exchange_rate': fields.related('currency_id', 'rate', type='float', digits=(16,2), string='Exchange Rate'),
...
class account_tax_code(osv.osv):
    ...
    _columns = {
        ...
        'sum': fields.function(_sum_year, type='float', digits=(16,2), string="Year Sum"),
        'sum_period': fields.function(_sum_period, type='float', digits=(16,2), string="Period Sum"),

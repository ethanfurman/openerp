...
class account_analytic_line(osv.osv):
    ...
    _columns = {
        'amount_currency': fields.function(_get_amount, string="Amount Currency", type="float", digits=(16,2), store=True, help="The amount expressed in the related account currency if not equal to the company one.", readonly=True),
